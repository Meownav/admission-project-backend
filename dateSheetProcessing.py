...
#             a = line.split()
#             if is_first and any(
#                 ds in line.lower() for ds in ["date sheet for", "date-sheet for"]
#             ):
#                 d = line.split("for")
#                 a = d[1]
#                 a = d[1].split()
...
#             DF.loc[idx, "Course"] = "".join(
#                 (str.split(DF.loc[idx, "Programme Name"], ")")[0] + ")").split()
#             ).lower()
#         else:
#             DF.loc[idx, "Course"] = "".join(
#                 DF.loc[idx, "Programme Name"].split()
#             ).lower()
#     return DF
...
# def add_columns(
#     DF,
# ):  # these columns will be used at the time of printing of examination schedule
#     abbrevations = {
...
#     DF["col1"] = (
#         DF["Short Form"].astype(str) + "-" + DF["Paper Term"].astype(str) + "-SMT"
#     )
...
#                     )
#                     and (
#                         studentDf.loc[studentIdx, "Paper Term"]
#                         == dateTimeDf.loc[dateIdx, "TERM"]
#                     )
#                     and (
#                         (np.isnan(dateTimeDf.loc[dateIdx, "COURSE"]))
#                         or (
#                             studentDf.loc[studentIdx, "Course"]
#                             == dateTimeDf.loc[dateIdx, "COURSE"]
#                         )
#                     )
#                 ):
